...
const DetailFilmPoster = ({ filmDetails }) => {
    ...
    return (
        <div style={{ height: "532px" }}>
            <img src={`https://www.themoviedb.org/t/p/original/${filmDetails?.poster_path}`} alt="" />
...
export default DetailFilmPoster